/* NCD MODULE — Google Sheet renderer, exact 3-part NCD header layout */
(function(){
'use strict';
...
const NCD_HEADERS=[
 'Subcenter','Total Population','Screening Target (47.8% of Total Population)','Enrollment 30+ (Progressive)','%','ABHA Link (Progressive)','ABHA Link %',
 'HTN','DM'
];
...
function table(dataRows){
 ...
 NCD_HEADERS.slice(0,7).forEach(v=>{const th=document.createElement('th');th.textContent=v;th.rowSpan=2;r1.appendChild(th)});
 let th=document.createElement('th');th.textContent='HTN';th.colSpan=8;r1.appendChild(th);
 th=document.createElement('th');th.textContent='DM';th.colSpan=8;r1.appendChild(th);
 thd.appendChild(r1);
